...
interface IconManageDataProps {
  className?: string;
}

const IconManageData: FC<IconManageDataProps> = ({ className }) => {
  return (
    <svg
      className={`${className} w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
      aria-hidden="true"
